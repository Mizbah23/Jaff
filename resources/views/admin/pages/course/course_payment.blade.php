            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body " style="padding-bottom: 0px;">
                        <form method="get" action="{{route('course.report')}}" target="_blank">
                        <div class="row">
                ...
                <div class="card-content">
                    <div class="card-body " >
                        <div class="row">
                            ...
                            <p class="mb-0" style="font-size: 11px;">Total Course Payment</p>
                        </div>
                            </div>
                            <div class="col-xl-6 col-md-6 col-12 mb-1">
...
<!--                                    <li class="breadcrumb-item"><a href="#">Components</a>
                        ...
                        <li class="breadcrumb-item active">Course Payment List
                        </li>
