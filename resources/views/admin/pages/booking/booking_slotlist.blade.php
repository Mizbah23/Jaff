                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-3 col-md-6 col-12 mb-1">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="text" class="form-control pickatime" id="fromtime" placeholder="From Time">
                                                </fieldset>
                                            </div>
                                            ...
                                            <div class="col-xl-3 col-md-6 col-12 mb-1">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="text" class="form-control pickatime" id="totime" placeholder="To Time">
                                                </fieldset>
                                            </div>
