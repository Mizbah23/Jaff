                ...
                <div class="card-content">
                    <div class="card-body " >
                        <div class="row">
                            ...
                            <p class="mb-0" style="font-size: 10px;">Total Booking's Payment</p>
                        </div>
                            </div>
                            <div class="col-xl-6 col-md-6 col-12 mb-1">
...
<!--                                    <li class="breadcrumb-item"><a href="#">Components</a>
                        ...
                        <li class="breadcrumb-item active">Booking's Payment List
                        </li>
...
<!--
                ...
                <div class="card-content">
                    <div class="card-body card-dashboard"  style="padding-top:0px;">
                        <div class="table-responsive">
                            <table id="bpTbl" class="table zero-configuration ">
                                <thead>
