                ...
                <div class="col-sm-12">
                    <div class="card overflow-hidden">
                        <form method="post" id="addFrm" enctype="multipart/form-data"> 
                            @csrf
                            <input type="hidden" name="old_month" id="old_month">
                            <input type="hidden" name="old_slot" id="old_slot">
                       <div class="card-content">
                                    <div class="card-body">
                                        
    <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="offer-tab" data-toggle="tab" href="#offer" aria-controls="offer" role="tab" aria-selected="true">
                User Calendar
            </a>
        </li>
<!--        <li class="nav-item">
            ...
            <div class="row" >  
                    <div class="col-md-8 col-xs-8 col-md-offset-2 col-xs-offset-2">
                        <fieldset class="form-group">
                            <label for="basicInput">Number of Months (visible slots for user)</label>
                            <input type="number" class="form-control" name="max_month" id="max_month" value="{{$info->max_month}}" placeholder="Number of Months">
                        </fieldset>   
                    </div>
                    <div class="col-md-8 col-xs-8 col-md-offset-2 col-xs-offset-2">
                        <fieldset class="form-group">
                            <label for="basicInput">Maximum Slots (eligible for booking without payment)</label>
                            <input type="text" class="form-control" name="max_slot" id="max_slot" value="{{$info->max_slot}}" placeholder="Number of Slots">
                        </fieldset>   
                    </div>
                    {{csrf_field()}} 
                </div>
