    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info white">
                <h5 class="modal-title" id="myModalLabel130" style="text-align: center;">Add Child Account</h5>
                ...
                <div class="row" >
                    <div class="col-md-12 col-12">
                        <div class="form-group checkphn">
                         ...
                         <select name="secid" class="form-control select2">
                            @foreach($secs as $sec)
                    ...
                    <div class="col-md-12 col-12 ">
                        ...
                        <label for="first-name-icon">Child Account</label><span> 
                            <input type="text" class="form-control emark" id="checkacc" name="grp_name" required="" placeholder="Enter Parent Account">
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success white">
                <h5 class="modal-title" id="myModalLabel130" style="text-align: center;">Update Child Account</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
        ...
        <form method="post" id="upForm" enctype="multipart/form-data">    
            <div class="modal-body" style="padding-top: 23px;">
                <div class="row" >
                   <input type="hidden" class="form-control" name="grpid" id="grpid">
                    <div class="col-md-12 col-12">
                        <div class="form-group checkphn">
                         <label for="first-name-icon">Parent Account</label>
                    ...
                    <div class="col-md-12 col-12 ">
                        ...
                        <label for="first-name-icon">Child Account</label><span> 
                            <input type="text" class="form-control emark" id="ucheckacc" name="ugrp_name" required="" placeholder="Enter Parent Account">
                        <div class="valid-feedback evtxt"></div><div class="invalid-feedback eitxt"></div>
                         </div>
                    </div> 
...
<div class="modal fade delMdl" id="animation" tabindex="-1" role="dialog" aria-labelledby="myModalLabel6" aria-modal="true">
    <div class="modal-dialog modal-dialog modal-dialog-scrollable" role="document">
        ...
        <div class="modal-header bg-primary">
            <h5 class="modal-title" id="exampleModalScrollableTitle">Delete Child Account</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="card">
                <div class="card-header" style="padding-top:3px;">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><b>Child Accounts</b>
                ...
                <div class="card-content">
                    <div class="card-body card-dashboard"  style="padding-top:0px;">
                        <div class="table-responsive">
                            <table id="grpTbl" class="table zero-configuration ">
                                <thead>
...
<script>
    ...
    {
       $('.agrp').addClass('active');
       $('.acc').addClass('has-sub sidebar-group-active open');
    });
    var table = $('#grpTbl').DataTable(
    {
        "responsive" : true,
        "autoWidth"  : false,
//      "ordering": false,
...
$(document).on('click', '.editmdl', function()
{
    ...
    $('#usecid').val($(this).data('secid'));$('#usecid').trigger('change');
    $('#ucheckacc').val($(this).data('grpname'));
...
{
    $.ajax({
      type: 'POST',url: "{{route('status.agrp')}}",
      data: {
        _token: $('meta[name="csrf-token"]').attr('content'),
