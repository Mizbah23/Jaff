...
<!-- *****************************add model**********************************-->
<div class="modal fade addOfferModel" id="exampleModalScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info white">
                <h5 class="modal-title" id="exampleModalScrollableTitle">Create Offer</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body" style="padding-top: 23px;">
                <form method="post" id="addOfferForm" enctype="multipart/form-data">    
                <div class="row" >  
                    <div class="col-md-4 col-xs-4 ">
                        <fieldset class="form-group">
                            <label for="basicInput">Start Date</label>
                            <input type="text" class="form-control pickadate" name="offer_start" id="offer_date" placeholder="Offer Start date">
                        </fieldset>   
                    </div>
                    <div class="col-md-4 col-xs-4">
                        <fieldset class="form-group">
                            <label for="basicInput">End Date</label>
                            <input type="text" class="form-control pickadate" name="offer_end" id="offer_end" placeholder="Offer End date">
                        </fieldset>   
                    </div>
                    <div class="col-md-4 col-xs-4">
                    ...
                    <div class="col-md-9 col-xs-9 ">
                        <fieldset class="form-group">
                            ...
                            <input type="text" class="form-control" name="offer_title" id="offer_title" placeholder="Offer Applicable for the date">
                        </fieldset>   
                    </div>
                    <div class="col-md-3 col-xs-3 ">
                        <fieldset class="form-group">
                            <label for="basicInput">Percentage(%)</label>
                            <input type="number" class="form-control" name="percentage" id="percentage" placeholder="Offer Percetage Amount ">
                        </fieldset>   
                    </div>
<!--                    <div class="col-md-3 col-xs-3">
                        <div class="form-group">
                            ...
                            <select name="slot_id" id="slot_id" class="select2 form-control" placeholder="Type">
                                ...
                                <option value="{{$slot->id}}">{{date('h:iA',strtotime($slot->start)).'-'.date('h:iA',strtotime($slot->end))}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>-->
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <textarea name="details" id="details" rows="10" class="form-control" placeholder="Offer Details"></textarea>
                        </div>
                    </div>
                    {{csrf_field()}}
                </div>
...
<!-- *****************************edit model**********************************-->
<div class="modal fade upOfferModel" id="exampleModalScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding-top: 23px;">
                <form method="post" id="upOfferForm" enctype="multipart/form-data">    
                <div class="row" >  
...
<!-- *****************************delete model**********************************-->
<div class="modal fade delOfferMdl" id="animation" tabindex="-1" role="dialog" aria-labelledby="myModalLabel6" aria-modal="true">
                    ...
                    <div class="card-body " >
                        <div class="row">
                            ...
                            <div class="avatar-content">
                                <i class="feather icon-gift text-danger font-medium-5"></i>
                            </div>
                        </div>
                            </div>
                        </div>
...
<!--
                ...
                <div class="card-content">
                    <div class="card-body card-dashboard"  style="padding-top:0px;">
                        <div class="table-responsive">
                            <table id="ofrTbl" class="table zero-configuration ">
                                <thead>
